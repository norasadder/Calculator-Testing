...
describe("Calculator", () => {
  ...
  it("should throw an error for invalid input types", () => {
    expect(() => calc(2, "+", 3, "*", 4, "-", "5", "/", 2, "*", 3)).toThrow(
      "Invalid input type"
    );
  });

  it("should throw an error for division by zero", () => {
    expect(() => calc(2, "+", 3, "*", 4, "-", 5, "/", 0, "*", 3)).toThrow(
      "Division by zero"
    );
  });
  ...
  it("should ignore the operand with value greater than 1000", () => {
    expect(calc(2, "+", 1005, "*", 4, "-", 5, "/", 2, "*", 3)).toBe(-1.5);
  });

  it("should ignore the operand with value greater than 1000", () => {
    expect(calc(2, "+", 3, "*", 4, "-", 1001, "/", 2, "*", 3)).toBe(12.5);
  });

  it("should ignore the operand with value greater than 1000", () => {
    expect(calc(1001, "+", 3, "*", 4, "-", 5, "/", 2, "*", 3)).toBe(4.5);
  });

  it("should ignore the operand with value greater than 1000", () => {
    expect(calc(1001, "-", 3, "*", 4, "-", 5, "/", 2, "*", 3)).toBe(-19.5);
  });
});
